...
public partial class PhpCreateWindow : Window
{
    ...
    public PhpCreateWindow(ApplicationModel applicationModel, IAzGlobalStore azGlobalStore, IAzWebAppsApiClient azWebAppsApiClient, AzWebAppWithHostname? azWebAppWithHostname = null)
    {
